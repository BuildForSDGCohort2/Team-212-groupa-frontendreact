          ...
          <div className="row">
            <div className="col-md-3 mt-5">
              <div className="card #1b5e20 green darken-4">
                ...
                <div className="card-body">
                  <img src={landPrep} alt="crop" className="img-responsive imgMore" />
                </div>
            ...
            <div className="col-md-3 mt-5">
              <div className="card #1b5e20 green darken-4">
                ...
                <div className="card-body">
                  <img src={cropSelect} alt="crop" className="img-responsive imgMore" />
                </div>
                <div className="card-footer">
                  {" "}
            ...
            <div className="col-md-3 mt-5">
              <div className="card #1b5e20 green darken-4">
                ...
                <div className="card-body">
                  <img src={fertilizer} alt="crop" className="img-responsive imgMore" />
                </div>
                <div className="card-footer">
                  {" "}
            ...
            <div className="col-md-3 mt-5">
              <div className="card #1b5e20 green darken-4">
                ...
                <div className="card-body">
                  <img src={marketing} alt="crop" className="img-responsive imgMore" />
                </div>
                <div className="card-footer">
                  {" "}
